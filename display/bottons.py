...
from .constances import MAP_BUTTONS_POINTS, MAP_BUTTONS_TEXTS, MAP_BUTTONS_CALLBACKS_NAME, CARDS_BUTTONS_POINTS, CARDS_BUTTONS_TEXTS, MAP_SMALL_BUTTONS_POINTS, MAP_SMALL_BUTTONS_TEXTS, BUTTON_WHIDTH, BUTTON_HIGHT, SMALL_BUTTON_WHIDTH, SMALL_BUTTON_HIGHT, MAP_SMALL_CALLBACKS_NAME, CARDS_BUTTONS_CALLBACKS_NAME, CARDS_SMALL_CALLBACKS_NAME, CARDS_SMALL_BUTTONS_TEXTS, CARDS_SMALL_BUTTONS_POINTS
